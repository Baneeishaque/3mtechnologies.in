...
<head>
    <title>
        3m Technologies | Video-Conference
    </title>
...
?>
<div id="main">
    <div class="p_head">Video-Conference</div>
    <div class="p_details_main">
        <div class="p_details_left">
            <div class="p_details">
                We are offering to our clients trustworthy services on range of Keyboard Controllers. These are
                installed by us to facilitate controlling of all devices by a single access point. Our expert
                professionals are engaged in catering to the individualized requirements of the clients and ensure
                compliance with the established norms of the industry.
            </div>
            <div class="p_move">
    ...
    <div class="p_head">olycom CX5000 Video conferencing device</div>
    <div class="p_dvr_mainn">
        <div class="p_dvr_main_leftt"></div>
        <div class="p_dvr_main_left_rightt">
            <div class="p_dvr_fulll">

                The Polycom CX5000 (formerly Microsoft RoundTable) is an advanced collaboration and conferencing device
                that delivers an engaging meeting experience. Now you don't have to sacrifice quality interaction due to
                budget or travel limitations; the CX5000 device allows for a rich meeting experience across multiple
                locations without sacrificing quality interaction.<br>
                <b>Feature</b><br>
                &raquo; Fully engage all participants with 360-degree panoramic video of everyone in the conference room<br>
