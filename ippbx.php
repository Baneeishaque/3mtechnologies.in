...
<div id="main">
    ...
    <div class="p_details_main">
        <div class="p_details_left">
            <div class="p_details">
                We are one of the leading providers of reliable installation and networking services on IPPBX Phone.
                These services are ideally suited for diverse commercial and official establishments. Our well trained
                professionals are capable of catering to the diverse requirements of the clients and they can
                effectively install these in preexisting as well as new networks
            </div>
            <div class="p_move">
    ...
    <div class="p_head">IPPBX Phone</div>
    <div class="p_dvr_mainn">
        <div class="p_dvr_main_leftt"></div>
        <div class="p_dvr_main_left_rightt">
            <div class="p_dvr_fulll">
                Clients across industries and offices can avail superior installation and networking services on IPPBX
                phones. The qualified professionals employed by us, comprehend and cater to the diverse requirements of
                the clients. These services can be utilized for new and preexisting networks as per the clients' demands
