...
?>
<div id="main">
    <div class="p_head">Computer Network</div>
    <div class="p_details_main">
        <div class="p_details_left">
            <div class="p_details">
                3m Technologies provides a wide range of computer networking services. We have the full spectrum
                covered. Our consultants are fully trained and able to provide immediate break/fix solutions for your
                business. Our ultimate goal is to be able to gain your confidence to maintain and support your computer
                network system so you can focus on your company's goals and missions.
            </div>
            <div class="p_move">
    ...
    <div class="p_dvr_mainn">
        ...
        <div class="p_dvr_main_left_rightt">
            <div class="p_dvr_fulll">We offer affordable solutions for Network Management Services for the small to
                medium sized business. Our goal is to be involved in your business daily and not just as needed. We
                offer hourly rates as well as monthly flat fee rates that include all aspects of Network Management. If
                you choose a monthly flat rate, then our team monitors your network system including servers, desktop
                workstations, internet connectivity and networking hardware on a daily basis using high tech monitoring
                programs and hardware as well as weekly scheduled site visits.
            </div>
        </div>
    </div>
