...
<head>
    <title>
        3m Technologies | Time Attendance
    </title>
    ...
    <style>
        ...
        .p_dvr_main_lefttt {
            background: url('timee_p.gif');
            width: 300px;
            float: right;
            height: 250px;
        }

        .p_dvr_main_left_righttt {
            background: #00559B;
            width: 700px;
            float: left;
            height: 250px;
...
?>
<div id="main">
    <div class="p_head">Time attendance system</div>
    <div class="p_details_main">
        <div class="p_details_left">
            <div class="p_details">

                <b>Time attendance system</b><br>We are one of the most celebrated providers of Time Attendance System.
                We are dealing with various brands and products like, Bio Online / Offline, Bio Finger, Bio Office, FPT
                2000, MProx, Bio Cam, Bio-Time 1, Bio-Time 2, Bio-Time 2B, Bio-Time 3, Bio-Time 4 and Bio-Smart.
            </div>
            <div class="p_move">
    ...
    <div class="p_head"> Accessing Control</div>
    <div class="p_dvr_mainn">
        ...
        <div class="p_dvr_main_left_rightt">
            <div class="p_dvr_fulll">We deliver various door access control equipments. Like, Bio Online / Offline, Bio
                Finger, Bio-A1, Bio Smart, Access Control and more..<br><b>Feature:</b><br>&raquo;Verification Method :
                Fingerprint, Fingerprint + Smartcard, Fingerprint + Password, Password + Smartcard <br>&raquo;Verification
                Mode : 1:1 (5000 persons), 1:N (Less than 1000 persons)
            </div>
        </div>
    </div>

    <div class="p_dvr_mainnn">
        <div class="p_dvr_main_lefttt"></div>
        <div class="p_dvr_main_left_righttt">
            <div class="p_dvr_fullll"><b>More Features:</b><br>&raquo;Verification Time : Less than 2.0 Sec<br>&raquo;Registration
                Time : Less than 3.0 Sec<br>&raquo;Capacity : 5,000 persons (10,000 templates)<br>&raquo; Log Data :
                65,000 events<br>&raquo;Communication : RS232/485, TCP/IP, Weigend 26/34 bit input and output
            </div>
        </div>
    </div>
</div>
