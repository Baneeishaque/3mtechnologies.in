...
<head>
    <title>
        3m Technologies | Keyboard Controller
    </title>
...
?>
<div id="main">
    <div class="p_head">Key board Controller</div>
    ...
    <div class="p_head">Specification-DVR technology</div>
    <div class="p_dvr_mainn">
        <div class="p_dvr_main_leftt"></div>
        <div class="p_dvr_main_left_rightt">
            <div class="p_dvr_fulll">
                &raquo; Variable-speed joystick control of PTZ and dome control<br>
                &raquo; Preset position, cruise and pattern control<br>
                &raquo; Auto/Figure scanning<br>
                &raquo; Select cameras and monitors<br>
                &raquo; Big-size LCD display<br>
                &raquo;Built-in multi-control protocols
            </div>
        </div>
    </div>
